var('a b x ')
lst=[["cos(x)^4/(I+cot(x))",x,5,"-1/16*I*x+1/32/(I-cot(x))^2+1/8*I/(I-cot(x))-1/24*I/(I+cot(x))^3+5/32/(I+cot(x))^2+3/16*I/(I+cot(x))"],
...
["cos(x)^3/(a+b*cot(x))",x,10,"a^3*b*arctanh((a*cos(x)-b*sin(x))/(a^2+b^2)^(1/2))/(a^2+b^2)^(5/2)-a^2*b*cos(x)/(a^2+b^2)^2-1/3*b*cos(x)^3/(a^2+b^2)-a*b^2*sin(x)/(a^2+b^2)^2+a*sin(x)/(a^2+b^2)-1/3*a*sin(x)^3/(a^2+b^2)"],
["cos(x)^2/(a+b*cot(x))",x,7,"1/2*a*(a^2-b^2)*x/(a^2+b^2)^2-a^2*b*log(b*cos(x)+a*sin(x))/(a^2+b^2)^2+1/2*(b+a*cot(x))*sin(x)^2/(a^2+b^2)"],
["cos(x)/(a+b*cot(x))",x,6,"a*b*arctanh((a*cos(x)-b*sin(x))/(a^2+b^2)^(1/2))/(a^2+b^2)^(3/2)-b*cos(x)/(a^2+b^2)+a*sin(x)/(a^2+b^2)"],
["sec(x)/(a+b*cot(x))",x,6,"arctanh(sin(x))/a+b*arctanh((a*cos(x)-b*sin(x))/(a^2+b^2)^(1/2))/a/(a^2+b^2)^(1/2)"],
["sec(x)^2/(a+b*cot(x))",x,3,"-b*log(a+b*cot(x))/a^2-b*log(tan(x))/a^2+tan(x)/a"],
["sec(x)^3/(a+b*cot(x))",x,9,"1/2*arctanh(sin(x))/a+b^2*arctanh(sin(x))/a^3-b*sec(x)/a^2+b*arctanh((a*cos(x)-b*sin(x))/(a^2+b^2)^(1/2))*(a^2+b^2)^(1/2)/a^3+1/2*sec(x)*tan(x)/a"],
...
["sec(x)/(1+2*cot(x))",x,6,"arctanh(sin(x))+2/5*arctanh(1/5*(cos(x)-2*sin(x))*5^(1/2))*5^(1/2)"]]
