var('a b n x ')
lst=[["sin(x)^4/(I+cot(x))",x,4,"-5/16*I*x+1/32/(I-cot(x))^2-1/8*I/(I-cot(x))-1/24*I/(I+cot(x))^3-3/32/(I+cot(x))^2+3/16*I/(I+cot(x))"],
...
["csc(x)^5/(a+b*cot(x))",x,9,"1/2*a*arctanh(cos(x))/b^2+a*(a^2+b^2)*arctanh(cos(x))/b^4+(a^2+b^2)^(3/2)*arctanh((b-a*cot(x))*sin(x)/(a^2+b^2)^(1/2))/b^4-(a^2+b^2)*csc(x)/b^3+1/2*a*cot(x)*csc(x)/b^2-1/3*csc(x)^3/b"],
["csc(x)^3/(a+b*cot(x))",x,5,"a*arctanh(cos(x))/b^2-csc(x)/b+arctanh((b-a*cot(x))*sin(x)/(a^2+b^2)^(1/2))*(a^2+b^2)^(1/2)/b^2"],
["csc(x)/(a+b*cot(x))",x,2,"-arctanh((-b+a*cot(x))*sin(x)/(a^2+b^2)^(1/2))/(a^2+b^2)^(1/2)"],
["sin(x)/(a+b*cot(x))",x,5,"b^2*arctanh((b-a*cot(x))*sin(x)/(a^2+b^2)^(1/2))/(a^2+b^2)^(3/2)-a*cos(x)/(a^2+b^2)-b*sin(x)/(a^2+b^2)"],
["sin(x)^3/(a+b*cot(x))",x,9,"b^4*arctanh((b-a*cot(x))*sin(x)/(a^2+b^2)^(1/2))/(a^2+b^2)^(5/2)-a*b^2*cos(x)/(a^2+b^2)^2-a*cos(x)/(a^2+b^2)+1/3*a*cos(x)^3/(a^2+b^2)-b^3*sin(x)/(a^2+b^2)^2-1/3*b*sin(x)^3/(a^2+b^2)"],
