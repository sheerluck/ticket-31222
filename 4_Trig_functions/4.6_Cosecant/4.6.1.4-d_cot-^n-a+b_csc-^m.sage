var('a b x ')
lst=[["tan(x)^4/(a+a*csc(x))",x,5,"x/a-1/15*(15-8*csc(x))*tan(x)/a+1/15*(5-4*csc(x))*tan(x)^3/a-1/5*(1-csc(x))*tan(x)^5/a"],
...
["cot(x)^3/(a+b*csc(x))",x,3,"-csc(x)/b-(1-1/b^2*a^2)*log(a+b*csc(x))/a-log(sin(x))/a"],
...
["tan(x)^4/(a+b*csc(x))",x,16,"x/a+2*b^5*arctanh((a+b*tan(1/2*x))/(a^2-b^2)^(1/2))/a/(a^2-b^2)^(5/2)-b^3*sec(x)/(a^2-b^2)^2+b*sec(x)/(a^2-b^2)-1/3*b*sec(x)^3/(a^2-b^2)+a*b^2*tan(x)/(a^2-b^2)^2-a*tan(x)/(a^2-b^2)+1/3*a*tan(x)^3/(a^2-b^2)"],
["tan(x)^2/(a+b*csc(x))",x,10,"-x/a+2*b^3*arctanh((a+b*tan(1/2*x))/(a^2-b^2)^(1/2))/a/(a^2-b^2)^(3/2)-b*sec(x)/(a^2-b^2)+a*tan(x)/(a^2-b^2)"],
["cot(x)^2/(a+b*csc(x))",x,8,"-x/a-arctanh(cos(x))/b+2*arctanh((a+b*tan(1/2*x))/(a^2-b^2)^(1/2))*(a^2-b^2)^(1/2)/a/b"],
["cot(x)^4/(a+b*csc(x))",x,7,"x/a-1/2*(2*a^2-3*b^2)*arctanh(cos(x))/b^3+2*(a^2-b^2)^(3/2)*arctanh((a+b*tan(1/2*x))/(a^2-b^2)^(1/2))/a/b^3+a*cot(x)/b^2-1/2*cot(x)*csc(x)/b"],
["cot(x)^6/(a+b*csc(x))",x,16,"-x/a-3/8*arctanh(cos(x))/b-1/2*(a^2-3*b^2)*arctanh(cos(x))/b^3-(a^4-3*a^2*b^2+3*b^4)*arctanh(cos(x))/b^5+2*(a^2-b^2)^(5/2)*arctanh((a+b*tan(1/2*x))/(a^2-b^2)^(1/2))/a/b^5+a*cot(x)/b^2+a*(a^2-3*b^2)*cot(x)/b^4+1/3*a*cot(x)^3/b^2-3/8*cot(x)*csc(x)/b-1/2*(a^2-3*b^2)*cot(x)*csc(x)/b^3-1/4*cot(x)*csc(x)^3/b"]]
